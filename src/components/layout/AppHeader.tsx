    ...
    <header className="h-12 sm:h-14 border-b border-border bg-card/80 backdrop-blur-md px-2 sm:px-3 md:px-4 flex items-center justify-between shrink-0 touch-target">
      <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 min-w-0 flex-1 mr-2">
        <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 shrink-0">
          <Link to="/" className="group touch-target">
            <Tooltip>
              <TooltipTrigger asChild>
                <img 
                  src="/vizor-logo.jpeg" 
                  alt="Vizor Logo" 
                  className="h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 rounded-lg object-cover shadow-lg hover:scale-110 transition-transform cursor-pointer"
                />
              </TooltipTrigger>
              <TooltipContent>Back to Home</TooltipContent>
            </Tooltip>
          </Link>
          <Link to="/" className="hover:opacity-80 transition-opacity touch-target">
